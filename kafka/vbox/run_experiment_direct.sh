...
nixops set-args -d swisscom-kafka-vbox --argstr experiment direct
...
nixops ssh client-1 mkdir -p $BENCH_RESULT_DIR
nixops ssh client-1 -t -t run-kafka-benchmark $BENCH_RESULT_DIR
echo "DONE"
